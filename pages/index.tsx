  ...
  return (
    <div className="flex flex-col items-center justify-center w-full px-5 py-10 min-h-screen bg-white">
      ...
      <div className="mb-10 flex flex-col w-full space-y-5 items-center justify-center">
        <a href="https://ducktility.studio/" className="font-extrabold text-2xl underline text-black hover:text-red-300 focus:text-red-400 active:text-red-400">리뉴얼된 취향표 사이트로 와 주세요!</a>
        <NavigationButton
          onClick={() => {}}
          href={"/nine"}
          title={"1인용 9문항 만들기"}
